...
#The two networks used were generated from data subset 2.
...
project_main_dir <- '/home/wnamm/documents/Moffitt_Shaw_Lab/aml_NetBID2_runs/FredHutch_subset2'
project_name <- 'TCGA_Network'
network.project.name <- 'project_2021-09-22'
network.dir= "/home/wnamm/documents/Moffitt_Shaw_Lab/aml_NetBID2_runs/FredHutch_subset2"
...
mat = read.table("/home/wnamm/documents/Moffitt_Shaw_Lab/aml_NetBID2_runs/FredHutch_subset2/FredHutch_1TPM_Final.txt", sep="\t", header=T, row.names=1);
...
write.table(ac_mat, file="/home/wnamm/documents/Moffitt_Shaw_Lab/aml_NetBID2_runs/FredHutch_subset2/TF_Calculated_Activity_2.txt",sep="\t");

write.table(sig_ac_mat, file="/home/wnamm/documents/Moffitt_Shaw_Lab/aml_NetBID2_runs/FredHutch_subset2/SIG_Calculated_Activity_2.txt",sep="\t");
